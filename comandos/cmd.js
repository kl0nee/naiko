module.exports = {
	...
	if(!command) return message.channel.send(require("../utils/emojis/deny.js")+" | Debes de poner el nombre de un comando")
	if(!comando) return message.channel.send(require("../utils/emojis/deny.js")+" | Ese comando no existe")
